...
class adsanity_random_ad_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array( 'classname' => 'adsanity-random', 'description' => 'Display a single random ad from an Ad Group.' );
		parent::__construct( 'adsanity-random', 'Adsanity - Random Ad', $widget_ops );
		add_action( 'admin_print_styles-widgets.php', create_function( '', 'wp_enqueue_style( "adsanity-random-widgets-admin" );' ) );
	}
...
add_action( 'widgets_init', create_function( '', "register_widget('adsanity_random_ad_Widget');" ) );
