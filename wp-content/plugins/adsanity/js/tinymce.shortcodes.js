		...
		init : function(ed, url) {
			...
			ed.addCommand('adsanity_ad', function() {
				ed.windowManager.open({
					file : ajaxurl + '?action=adsanity_shortcode_form', // url + '/../lib/ad_popup.php', // file that contains HTML for our modal window
			...
			ed.addCommand('adsanity_ad_group', function() {
				ed.windowManager.open({
					file : ajaxurl + '?action=adsanity_group_shortcode_form', // url + '/../lib/ad_group_popup.php', // file that contains HTML for our modal window
					width : 220 + parseInt(ed.getLang('button.delta_width', 0)), // size of our window
					height : 240 + parseInt(ed.getLang('button.delta_height', 0)), // size of our window
					inline : 1
				}, {
