...
/**
 * pj_cpt_base
 * This class provides base functionality for creating a new custom post type and should be extended
	...
	class pj_cpt_base {
		 ...
		 */
			...
			$setup_defaults = array(
				'labels' => apply_filters( 'pj_'.$this->type.'_labels', $label_defaults ),
				'public' => true,
		...
		function admin_print_styles() {
			if( get_query_var('post_type') == $this->type || get_post_type() == $this->type || ( isset( $_REQUEST['post_type'] ) && $_REQUEST['post_type'] == $this->type ) ) :
		 ...
		 */
			...
			if( !isset( $_POST[$nonce_field] ) || !wp_verify_nonce( $_POST[$nonce_field], $this->type.'-save_postmeta' ) ) return $post_id;
