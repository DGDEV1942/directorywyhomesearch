...
if( ($userdata->ID == 0 &&  is_array($GLOBALS['page_package_acecss']) && !in_array(0,$GLOBALS['page_package_acecss']) ) || ( $userdata->ID !=0 &&  isset($GLOBALS['membershipID']) && is_numeric($GLOBALS['membershipID']) && !in_array($GLOBALS['membershipID'],$GLOBALS['page_package_acecss']) ) ){
