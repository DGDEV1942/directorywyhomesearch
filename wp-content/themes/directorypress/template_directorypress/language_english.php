...
"english" => array(
	...
	"myaccount" => array(
		...
		"6" 			=> "My Directory Listings",
		"7" 			=> "Here you can view your existing directory listings.",
		"8" 			=> "Create New Listing",
		"9" 			=> "Here you can create a new directory listing.",		
		"10" 			=> "First Name",
		"11" 			=> "Last Name",
		"12" 			=> "Email",
		"13" 			=> "Website URL",
		...
		"30" 			=> "State/Province",
		"31" 			=> "Member Updated Successfully. <br />	Please allow a few minutes for account changes to update.",
		"32" 			=> "My Profile Page",		
		"33" 			=> "Company",
		"34" 			=> "VAT Number",		
		"35" 			=> "My Favorites",
