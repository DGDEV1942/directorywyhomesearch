...
$cat_id = wp_insert_term("Society", 'category', $args);
	...
	$idd = wp_create_category1('Issues', $cat_id['term_id']);
...
*/
$args = array('cat_name' => "Shopping" );
wp_update_term($idd, 'category', $args);
...
update_option('ppt_object_recent_title','Recently Added Listings');
$op[1] = 'carousel';
$op[2] = 'recent';
...
update_option('ppt_layout_columns','3');
update_option('ppt_homepage_columns','3');
...
update_option('sidebars_widgets','');
    ...
    $addWidget[2]['name'] = 'ppt-featured';
	$addWidget[2]['sidebar'] = 'sidebar-1';
	$addWidget[2]['defaults'] = array('title'=>'Featured Listings');
