...
function gateway_alertpay($data=""){
	...
	$gatewaycode = '<form name="gateway_alertpay" target="_top" method="post" action="https://www.payza.com/PayProcess.aspx">';
...
function gateway_eWay($data=""){
	...
	$gatewaycode = "";
		...
		$ewayurl.="&Amount=".$data['price']['total'];
...
<input type="hidden" name="amount" value="<?php if(strpos($_POST['price']['total'], ",") === false ){ echo $_POST['price']['total']; }else{ echo str_replace(",","",$_POST['price']['total']); } ?>" />
...
<?php echo MakePayButton('javascript:document.moneybook.submit();'); ?>
...
global $wpdb;
  ...
  $str=$str . '&Amount=' . $data['price']['total'];
