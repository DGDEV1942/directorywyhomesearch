...
class PPT_Admin extends PPT_API {
	...
	function PPT_Admin( $args = array() ) {
		...
		$api = array('ppt_admin.php','membership','setup','members','display','submit','advertising','analytics','tools','payments','orders','images','emails','import_products','import_movies','quickhelp','updates','shipping','checkout','import'); 
...
.titleh { background:url( <?php echo PPT_FW_IMG_URI; ?>admin/titlebg.png) repeat-x; border:1px solid #ddd;	margin-left:-11px; margin-right:-11px; margin-top:-11px; 	height:40px;	border-top-right-radius: 3px;    border-top-left-radius: 3px;	position:relative; border-bottom:1px solid #ccc;}	
 .titleh h3{ font-size:12px; color:#999; text-transform:uppercase; padding-left:10px; text-shadow: #fff 1px 1px 0;  }
