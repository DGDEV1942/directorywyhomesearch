...
<p class="f_half left"> 
    <label for="name">'.$PPT->_e(array('login','10')).':</label> 
...
<input type="submit" name="submit" id="submit" class="button gray" tabindex="15" value="'.$PPT->_e(array('login','18')).'" /> 
 ';
...
function isValidEmailAddress(emailAddress) {
    ...
    return pattern.test(emailAddress);
		...
		var user_login = document.getElementById("user_login");
			...
			var pak = document.getElementById("SELECTEDPACKAGEID");
			if(pak.value == '')
			{
...
$string .= '<div class="itembox"><h1>'.$PPT->_e(array('login','5')).'</h1><div class="itemboxinner"> 
