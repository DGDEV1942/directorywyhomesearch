      ...
      return this.each(
        function()
        {
          ...
          if (settings.window.expandable)
            $($this).after('<span class="jPicker" onclick="javascript:scroll(0,0);return false;"><span class="Icon"><span class="Color">&nbsp;</span><span class="Alpha">&nbsp;</span><span class="Image" title="Click To Open Color Picker">&nbsp;</span><span class="Container">&nbsp;</span></span></span>');
                  ...
                  container.css( // positions must be set and display set to absolute before source code injection or IE will size the container to fit the window
                    {
                      ...
                      position: 'absolute',
                      top: win.position.y == 'top' ? (popup.offset().top + 150) + 'px' :
