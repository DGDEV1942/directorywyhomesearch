...
<h3><img src="<?php echo PPT_FW_IMG_URI; ?>/admin/_ad_payment.png" align="middle"> Payments</h3>	 <a class="premiumpress_button" href="javascript:void(0);" onclick="PlayPPTVideo('MoLlB6pprJg','videobox1');"><img src="<?php echo PPT_FW_IMG_URI; ?>/admin/youtube.png" align="middle" style="margin-top:-10px;"> Help Me</a>							 
<ul>
