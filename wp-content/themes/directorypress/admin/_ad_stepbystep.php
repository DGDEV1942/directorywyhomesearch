...
<iframe src="http://www.premiumpress.com/gettingstarted/?h=1&amp;t=<?php echo strtolower(PREMIUMPRESS_SYSTEM); ?>&amp;v=<?php echo PREMIUMPRESS_VERSION; ?>" style="width:980px; height:1000px;" frameborder="0"></iframe>  			
<div class="clearfix"></div>       
<?php /*
<div class="panel" id="processPanel">

<a href="#content1" label="1"> Basic Setup </a>
<a href="#content2" label="2">Hosting &amp; Wordpress</a>
...
<?php echo $pca->BuildTable($hosting_info); ?>
<?php echo $pca->BuildTable($wordpress_info); ?></div>
