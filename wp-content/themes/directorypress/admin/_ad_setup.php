...
<fieldset>
<div class="titleh"> <h3>Layout</h3>  </div>
 
 


<div class="ppt-form-line">	
<span class="ppt-labeltext">Website Template
...
onclick="PPMsgBox(&quot;The list will display all of the child themes found in the folder; <br /><small> 'wp-content/themes/<?php echo strtolower(constant('PREMIUMPRESS_SYSTEM')); ?>/themes/'.</small><br /><br /><strong>The list is empty or will not save</strong><br />This is likely because you have renamed the theme folder to something other than '<?php echo strtolower(constant('PREMIUMPRESS_SYSTEM')); ?>' or that your file paths are not setup correctly on your hosting account.&quot;);"><img src="<?php echo PPT_FW_IMG_URI; ?>help.png" style="float:right;" /></a>
	...
	<select name="adminArray[theme]" style="width: 200px;  font-size:14px; backgound:red;" id="themepreview" title="Here you select the design for your website.">
		<?php
...
<div class="ppt-form-line">	
<center><div id="imagePreview"><?php if(get_option('theme') !=""){ ?> <img src="<?php echo $GLOBALS['template_url']; ?>/themes/<?php echo get_option('theme'); ?>/screenshot.png" style='border:1px solid #333;' /><?php } ?></div></center>
<div class="clearfix"></div>
</div>
...
<div class="ppt-form-line">	
<span class="ppt-labeltext">Upload Layout 
...
<div class="titleh"> <h3>Website Setup</h3></div>
 
 
<div class="ppt-form-line">	
<span class="ppt-labeltext">User Registration</span>	
...
<div class="ppt-form-line">	
<span class="ppt-labeltext">Default User Status</span>	
...
<div class="ppt-form-line">	
<span class="ppt-labeltext">Website Language
...
onclick="PPMsgBox(&quot;The list will display all of the files that begin with 'language_' in the folder; <br /><small> '<?php echo strtolower(constant('PREMIUMPRESS_SYSTEM')); ?>/template_<?php echo strtolower(constant('PREMIUMPRESS_SYSTEM')); ?>/'.</small><br /><br /><strong>The list is empty or will not save</strong><br />This is likely because you have renamed the theme folder to something other than '<?php echo strtolower(constant('PREMIUMPRESS_SYSTEM')); ?>' or that your file paths are not setup correctly on your hosting account.<br /><br /><strong>How to add my own language?</strong><br />Simply copy and rename the file 'language_english.php in the  folder; <br /><small> '<?php echo strtolower(constant('PREMIUMPRESS_SYSTEM')); ?>/template_<?php echo strtolower(constant('PREMIUMPRESS_SYSTEM')); ?>/'</small><br /> to something like 'language_french.php' and translate the text in that file.&quot;);"><img src="<?php echo PPT_FW_IMG_URI; ?>help.png" style="float:right;" /></a>
 ...
 <select name="adminArray[language]" class="small-input" class="ppt-forminput">
		<?php
...
<div class="ppt-form-line">	
<span class="ppt-labeltext">Mobile Friendly
...
onclick="PPMsgBox(&quot;<b>What's This?</b><br>The mobile friendly option will turn on a seperate website interface for mobile users, is a 'cut down' version of your main website with all main functionality such as registration and submission are disabled..&quot;);"><img src="<?php echo PPT_FW_IMG_URI; ?>help.png" style="float:right;" /></a>
 ...
 <select name="adminArray[ppt_mobile]" class="ppt-forminput">
...
<fieldset>
<div class="titleh"> <h3>Website Maintenance</h3></div>
...
?>
    ...
    <div class="titleh"> <h3>Button / Page Links </h3></div>
    
    <?php foreach($MakePagesArray as $pageBit){ ?>
    
<div class="ppt-form-line">	
<span class="ppt-labeltext"><?php echo $pageTitles[$pageBit]; ?> </span>	 
...
<div class="clearfix"></div>
     ...
     <div class="titleh"> <h3>Page Display Options </h3></div>
...
onclick="PPMsgBox(&quot;<b>What's This?</b><br>Sometimes you want to add pages to your website but not display them on your meny bars etc. This tool will help you hide pages from display. <br><br>Note. This only works with theme functions, third part widgets and function will not hide selected pages..&quot;);"><img src="<?php echo PPT_FW_IMG_URI; ?>help.png" style="float:right;" /></a>
       ...
       <select name="nav_page[]" multiple="multiple" style="width:350px;" data-placeholder="Choose a Page..." class="chzn-select"  tabindex="3" >
       <?php
       ...
       <small>selected pages will be hidden from theme functions</small>
...
<div class="clearfix"></div>      
       ...
       <select name="footer_nav_page[]" multiple="multiple" style="width:350px; height:200px;" data-placeholder="Choose a Page..." class="chzn-select">
       <option></option>
       <?php
		$SAVED_DISPLAY = get_option("footer_excluded_pages");
		if($SAVED_DISPLAY != ""){ $pageArray = explode(",",$SAVED_DISPLAY); }else{ $pageArray = array(); }
		$Pages = get_pages("parent=0"); //
		$Page_Count = count($Pages);	
 		$i=0;	 
...
<fieldset>
<div class="titleh"> <h3>File Storage Paths</h3></div>
...
<a href="javascript:void(0);" onclick="PlayPPTVideo('uOEKAKr5O4U','videobox55');"><img src="<?php echo $GLOBALS['template_url']; ?>/PPT/img/admin/video/7.jpg" align="absmiddle" /></a>
 ...
 <?php if(strtolower(constant('PREMIUMPRESS_SYSTEM')) == "directorypress" || strtolower(constant('PREMIUMPRESS_SYSTEM')) == "couponpress"){ ?>
	...
	<div class="grid400-left">
    <fieldset>
        <div class="titleh"><h3>Website Thumbnail API Comparison</h3></div>
        
        
        
        
        <div class="ppt-form-line">     
            <span class="ppt-labeltext">Website Thumbnail API</span>
		...
		<table id="stwwt_feature_comp">
			...
			<thead>
				...
				<tr>
					<th style="text-align: left;">Bypass <a href="http://www.shrinktheweb.com/content/what-stw-preview-verification.html" target="_blank">Preview Verification Page</a></th>
...
<div style="clear:right;"> 
 <fieldset>
<div class="titleh"> <h3>Image Options</h3></div>
...
onclick="PPMsgBox(&quot;<b>How does this work?</b><br />This image is used when a listing does not have a default image.&quot;);"><img src="<?php echo PPT_FW_IMG_URI; ?>help.png" style="float:right;" /></a>   
  ...
  <input name="adminArray[pptimage][noimage]" id="logo" type="text" class="ppt-forminput" value="<?php if(!isset($IMAGEVALUES['noimage']) || $IMAGEVALUES['noimage'] ==""){ echo "na.gif"; }else{ echo $IMAGEVALUES['noimage']; } ?>">
<div class="clearfix"></div>
...
<input id="upload_logo" type="button" size="36" name="upload_logo" value="Upload Image"  />
   ...
   <div class="ppt-form-line">     
   <span class="ppt-labeltext">Image Formatting</span>
...
onclick="PPMsgBox(&quot;<b>How does this work?</b><br />This feature will change the image display and give it a new render type.&quot;);"><img src="<?php echo PPT_FW_IMG_URI; ?>help.png" style="float:right;" /></a>   
   ...
   <p> <input name="adminArray[pptimage][displaytype]" type="radio" value="greyScale" <?php if($IMAGEVALUES['displaytype'] == "greyScale"){ echo 'checked=checked'; } ?> /> Grey Scale </p>
...
<?php } ?>
 ...
 <input class="button-primary" style="float:right;" type="submit" value="Save Image Options" onclick="document.getElementById('showThisTab').value=2" />
...
<?php if($IMAGEVALUES['thumbnailapi'] =="shrinktheweb"){  /* ============================ SHRINK THE WEB API ================================= */?>
    ...
    <fieldset>
        ...
        <?php
            ...
            <select name="adminArray[pptimage][stw_13]">
                <option value="free" <?php if($IMAGEVALUES['stw_13'] == "free"){ print "selected";} ?>>Free w/ PVP (see notes below)</option>
                <option value="pro" <?php if($IMAGEVALUES['stw_13'] == "pro"){ print "selected";} if($aResponse['stw_account_level'] == 0){ print " disabled";}?>>Basic or PLUS</option>
            </select>
                      
            <p class="ppnote"><b>Note:</b> ShrinkTheWeb free accounts use javascript. This may case some sliders and widgets and Google Map objects from working.</p>
        ...
        jQuery(document).ready(function(jQuery) {
          ...
          var insidepage = '<p class="insidepage" style="color:green;">Inside Pages are ON for Free w/ PVP</p>';
          ...
          function toggleAccType() {
            if (jQuery("select[name='adminArray[pptimage][stw_13]'] option:selected").val() == 'free') {
              jQuery("input[name='adminArray[pptimage][stw_1]']").attr("disabled", true);
              jQuery("input[name='adminArray[pptimage][stw_1]']").parent().append(insidepage);
            } else {
              jQuery("p.insidepage").remove();
            }
          }
          toggleAccType();
          
          jQuery("select[name='adminArray[stw_13]']").change(function() {
            toggleAccType();
          });
          
<?php if ($aResponse['stw_response_status'] == 'Success' && $aResponse['stw_account_level'] > '') { ?>

    if (<?php echo $aResponse['stw_inside_pages']; ?> == 0) {
      jQuery("input[name='adminArray[pptimage][stw_1]']").attr("checked", false);
      jQuery("input[name='adminArray[pptimage][stw_1]']").attr("disabled", true);
      if (<?php echo $aResponse['stw_account_level']; ?> != 0 && <?php echo $aResponse['stw_inside_pages']; ?> == 0 && '<?php echo $IMAGEVALUES['stw_13'];?>' != 'free') {
...
<?php }?>
	...
	<?php if ($aResponse['stw_response_status'] == 'Success' && $aResponse['stw_account_level'] > 0) { ?>
...
<!--            <div>
    ...
    <?php } else if ($aResponse['stw_response_status'] == 'Success' && $aResponse['stw_account_level'] == 0) {?>
            <br /><p class="insidepage" style="color:green;">Inside Pages are ON for Free w/ PVP</p>
            <p style="color:red"><a href="http://www.shrinktheweb.com/auth/order-page" target="_blank">Upgrade required to use "Basic or PLUS"</a></p>
            <small style="color:red">upgrade your account to enjoy our amazing features</small><br /><br />        
    <?php } else {?>
...
<fieldset>
<div class="titleh"> <h3>Category Display Options</h3></div>

<div class="ppt-form-line">	
<span class="ppt-labeltext">Category Count</span> 
   <a href="javascript:void(0);" onmouseover="this.style.cursor='pointer';" 
...
onclick="PPMsgBox(&quot;<b>How does this work?</b><br />Some times you may want to completely hide a category from dislay, by selecting the category here the system will hide from from display.&quot;);"><img src="<?php echo PPT_FW_IMG_URI; ?>help.png" style="float:right;" /></a>
    ...
    <select name="hidden_cats[]" multiple="multiple" style="width:100%; height:150px;" data-placeholder="Choose a Category..." class="chzn-select">
      <?php echo premiumpress_categorylist(explode(",",get_option('article_cats')),false,false,"category",0,true); ?>
    </select>
    <br /> <small>selected categories will be excluded from theme functions</small>
 </div>
</fieldset>

<fieldset>
<?php $text = get_option("cat_icons"); ?>
<div class="titleh"> <h3>Category Icons</h3></div>

 <p class="ppnote">Here you can setup customized icons for the home page category objects.</p>
  
  
	<select name='cat' onchange="CatIcon(this.value);"  style="width:350px; font-size:14px;">
	<option value='-1'>Select One</option>
	 <?php 
		...
		if($Maincat->parent ==0){		
			...
			if(isset($text[$Maincat->term_id]['image'])){ $catlist .= " [ icon name: ".$text[$Maincat->term_id]['image']." ]"; }
...
<div class="titleh"> <h3>Category Descriptions</h3></div>

 
 
 <p class="ppnote">Here you can setup customized category headers/descriptions which will appear at the top of the category when viewed by your website visitors.</p>
   
     
	<select name='cat' onchange="CatTextBox(this.value);"  style="width:350px; font-size:14px;">
	<option value='-1'>Select One</option>
	 <?php 
...
<fieldset>
<div class="titleh"> <h3>Category Display </h3></div> 

<p class="ppnote" style="width:95%;">This is used for ordering categories within the sidebar widgets. If you want to setup your navigation bar, use the <a href='nav-menus.php' style="font-weight:bold; text-decoration:underline;">Wordpress menu options here.</a> Below you tick the categories <b>YOU WANT</b> to be displayed on your website and enter a numeric value for their order. </p>
	...
	foreach ($Maincategories as $Maincat) {
		...
		print '<div style="background:#efefef; padding:8px; border:1px solid #ddd; font-size:12px; font-weight:bold; float:left; width:338px; margin-right:10px; margin-bottom:10px; "><input name="nav_cat['.$i.'][ID]" type="checkbox" 
		value="'.$Maincat->cat_ID.'"';
		if( isset($SAVED_DISPLAY[$i]) && isset($SAVED_DISPLAY[$i]['ID']) ){ print 'checked="checked"'; }
		print 'style="padding:0px; background:none; margin:0px;margin-right:10px;">' . $Maincat->cat_name.' ';
		print ' ( Order: <input name="nav_cat['.$i.'][ORDER]" type="text" value="';
		if(isset($SAVED_DISPLAY[$i]) && is_numeric($SAVED_DISPLAY[$i]['ORDER']) ){ print $SAVED_DISPLAY[$i]['ORDER']; }
...
<fieldset>
<div class="titleh"> <h3>Listing / Package Expiry</h3></div>

<?php if(strtolower(constant('PREMIUMPRESS_SYSTEM')) != "shopperpress"){   ?>
<div class="ppt-form-line">     
<span class="ppt-labeltext">Listing Expiry</span>
...
<?php if(get_option("feature_expiry") =="yes"){ ?>	 
 		...
 		<p><b>What happens once expired??</b></p>
...
<div class="ppt-form-line">     
<span class="ppt-labeltext">Automatic Listing Removal</span>
...
<fieldset>
<div class="titleh"> <h3>MISC / Extras</h3></div>

  <div class="ppt-form-line">     
<span class="ppt-labeltext">`nofollow` links</span>
...
<div class="clearfix"></div>
  ...
  <div class="ppt-form-line">     
<span class="ppt-labeltext">Link Cloaking</span>
...
<div class="videobox" id="videobox5">
<a href="javascript:void(0);" onclick="PlayPPTVideo('SOTWxQuPZT4','videobox5');"><img src="<?php echo $GLOBALS['template_url']; ?>/PPT/img/admin/video/4.jpg" align="absmiddle" /></a>
</div>   
...
if(is_array($value)){
	...
	echo '<div class="trigger"><a href="#">'.$i.'. '.$GLOBALS['_LANG'][$lang]['descriptions'][$language_array_keys[$i]].'. [click here to show/hide text]</a></div> <div class="container">';
 	echo '<table width="100%" border="0"><th>Current Text</th><th>Your Translation Here</th>';
 
	foreach($value as $key=>$val){  ?>
  <tr>
    <td><input name="" type="text" class="ppt-forminput" value="<?php echo $val; ?>" style="width:350px;" disabled="disabled" /></td>
    <td><input name="pplang[<?php echo $lang; ?>][<?php echo $language_array_keys[$i]; ?>][<?php echo $key; ?>]" type="text" class="ppt-forminput" 
    value="<?php if(isset($sl[$lang][$language_array_keys[$i]][$key])){ echo stripslashes($sl[$lang][$language_array_keys[$i]][$key]); } ?>" style="width:350px;" /></td>
  </tr> 
	...
	echo '<p><input class="premiumpress_button" type="submit" value="Save Text Changes" style="color:#fff;"  onclick="document.getElementById(\'showThisTab\').value=7" /></p>';
