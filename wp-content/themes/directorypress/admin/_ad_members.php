...
<h3><img src="<?php echo PPT_FW_IMG_URI; ?>/admin/_ad_members.png" align="middle"> Add/Edit Member</h3>	 <a class="premiumpress_button" href="javascript:void(0);" onclick="PlayPPTVideo('0XHvwwy4QYI','videobox1');">Help Me</a> 						 
<ul>
...
<fieldset>
<div class="titleh"> <h3>User Access</h3>  </div>


<div class="ppt-form-line">	
<span class="ppt-labeltext">Company Role
...
<option value="0" <?php if($ps == "" || $ps == 0){ echo "selected=selected"; } ?>>-- No Package -- </option>
 <?php 
	...
	foreach($packagedata['package'] as $package){
		...
		if($ps = $package['ID'] && $ps !=0){ $exta = "selected=selected"; }else{ $exta = ""; }
		
		echo "<option value='".$package['ID']."' ".$exta.">".$package['name']."</option>"; //$package['id']
...
<fieldset>
<div class="titleh"> <h3>User Photo</h3>  </div>
<style>
.frame img { 
...
<div class="titleh"> <h3>Account Notice</h3>  </div>
...
<div class="titleh"> <h3>Custom Profile Fields</h3>  </div>
...
<div class="titleh"> <h3>Account Details</h3>  </div>
...
<div class="titleh"> <h3>User Details</h3>  </div>
...
<div class="titleh"> <h3>Change Password</h3>  </div>
...
?></td>
<td><a href="<?php echo $e;?>"><?php echo $user->user_nicename; ?></a> <br /> <small><a href='mailto:<?php echo $user->user_email;?>' title='e-mail: <?php echo $user->user_email;?>'><?php echo $user->user_email;?> <img src="<?php echo $GLOBALS['template_url']; ?>/PPT/img/premiumpress/led-ico/note.png" align="middle" /></a> </small></td>
<td><?php echo $user->first_name.' '.$user->last_name;?>  <br /> <small>Created about <?php echo $timesince; ?></small> 
...
<fieldset>
<div class="titleh"> <h3>Default Registration Fields</h3></div>
...
<p><input name="df1" type="checkbox" value="1" onchange="ChangeTickValue('df1<?php echo $i; ?>');" <?php if($packagedata['default1'] == "1"){ ?>checked="checked"<?php } ?> />  Hide My Account Details Title</p>
<p><input name="df2" type="checkbox" value="1" onchange="ChangeTickValue('df2<?php echo $i; ?>');" style="margin-left:140px;" <?php if($packagedata['default2'] == "1"){ ?>checked="checked"<?php } ?> />  Hide First Name</p>
<p><input name="df3" type="checkbox" value="1" onchange="ChangeTickValue('df3<?php echo $i; ?>');" style="margin-left:140px;" <?php if($packagedata['default3'] == "1"){ ?>checked="checked"<?php } ?> />  Hide Last Name</p>
<p><input name="df4" type="checkbox" value="1" onchange="ChangeTickValue('df4<?php echo $i; ?>');" style="margin-left:140px;" <?php if($packagedata['default4'] == "1"){ ?>checked="checked"<?php } ?> />  Hide A few words about me..</p>
...
<div class="ppt-form-line">	
<p><input class="premiumpress_button" type="submit" value="Save Changes" style="color:#fff;" /> 
</p>
</div>					 
</form>
