<?php global $PPT; PremiumPress_Header(); ?>
...
<ul>
	<li><a rel="premiumpress_tab1" href="#" <?php if(isset($_POST['showThisTab']) && $_POST['showThisTab'] =="1"){ echo 'class="active"';}elseif(!isset($_POST['showThisTab'])){ echo 'class="active"'; } ?>>Setup Options</a></li>
...
<fieldset>
<div class="titleh"> <h3>Currency / Pricing</h3></div>
...
<div class="ppt-form-line">     
<span class="ppt-labeltext">Currency Symbol Position</span>
...
<p class="ppnote">Here you choose how many digits at the end of price tags.</p>
...
<fieldset>
<div class="titleh"> <h3>Default Submission Fields</h3></div>
...
<p><input name="adminArray[default_form_fields][url]" type="checkbox" value="1" <?php if($dfs['url'] == "1"){ echo 'checked=checked'; } ?> /> Website Address</p>
...
<fieldset><div class="titleh"> <h3>New Listing Settings</h3></div> 
...
<div class="ppt-form-line">	 
<input type="checkbox" name="package[<?php echo $i; ?>][pricecats]" value="1" <?php if(isset($packdata[$i]['pricecats']) && $packdata[$i]['pricecats'] ==1){ echo "checked"; } ?>> <strong>&nbsp;&nbsp;Show Price Per Category</strong><br />
<a href="javascript:void(0);" onmouseover="this.style.cursor='pointer';" 
...
<div class="titleh"> <h3>Package Setup</h3></div>
...
<input name="customfield[value][]" type="text"  class="ppt-forminput" value="<?php if(isset($cfield['value'])){ echo htmlentities($cfield['value']); } ?>" />
<div class="clearfix"></div>
</div>
