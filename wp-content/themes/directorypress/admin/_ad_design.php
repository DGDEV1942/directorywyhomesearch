...
<fieldset>
<div class="titleh"> <h3>Website Layout</h3></div>
...
<div class="titleh"><h3>General Website Styles</h3></div>
...
<div class="titleh"><h3>Navigation / Menu Bar Styles</h3></div>
...
<div class="titleh"><h3>Object Box / Item Box Styles</h3></div>
...
<div class="titleh"><h3>Footer Styles</h3></div>
...
<div class="titleh"><h3>Slider Styles</h3></div>
...
<div class="titleh"><h3>Custom Styles</h3></div>
...
<p><img src="<?php echo $GLOBALS['template_url']; ?>/PPT/img/admin/sdisplay.png" align="absmiddle" /> <a href="admin.php?page=display&dldesign=1">Download Styles File</a></p>
 ...
 <p><img src="<?php echo $GLOBALS['template_url']; ?>/PPT/img/admin/ssetup.png" align="absmiddle" /> <a href="javscript:void(0);" onclick="toggleLayer('importstylefile');">Import Styles File</a></p>
...
<input  type="submit" value="Reset All Display Settings" style="color:#666;; float:right; background:#ccc; padding:5px;cursor:pointer; margin-top:-40px;"/>
</form>  
...
<?php if(strtolower(PREMIUMPRESS_SYSTEM) == "shopperpress" && get_option("display_default_homepage") !="1"){ ?>
...
$b = array();
$b[1] = TEMPLATEPATH."/themes/".get_option('theme')."/images/badge1.gif";
$b[2] = TEMPLATEPATH."/themes/".get_option('theme')."/images/badge2.gif";
$b[3] = TEMPLATEPATH."/themes/".get_option('theme')."/images/badge3.gif";
$b[4] = TEMPLATEPATH."/themes/".get_option('theme')."/images/badge4.gif";
$b[5] = TEMPLATEPATH."/themes/".get_option('theme')."/images/badge5.gif";
$b[6] = TEMPLATEPATH."/themes/".get_option('theme')."/images/badge6.gif";
...
<div class="ppt-form-line">	
 <img src="<?php if(strlen(get_option("home_image_".$loopme)) > 1){ echo premiumpress_image_check(get_option("home_image_".$loopme),"full"); }else{ echo $GLOBALS['template_url']; ?>/themes/<?php echo get_option('theme'); ?>/images/badge<?php echo $loopme; ?>.gif<?php } ?>" alt="<?php echo get_option("home_title_".$loopme);  ?>" style="max-width:350px; max-height:200px;" />  
 </div>
    ...
    <option value='choose' <?php if($scat == "choose"){ ?>selected=selected<?php } ?>>** All Product's I Choose **</option>
	 <?php 
		...
		if($Maincat->parent ==0){		
			...
			if($scat == $Maincat->term_id){ $catlist .= ' selected=selected >'; }else{ $catlist .= '>'; }
			...
			$catlist .= '</option>';
				...
				$catlist .="<ul>";
					foreach ($categories as $cat) {		
						...
						if($scat == $cat->term_id){ $catlist .= ' selected=selected > --'; }else{ $catlist .= '> --'; }
...
<fieldset>
<div class="titleh"><h3>Inactive Home Page Objects</h3></div>
...
$available_items[$ic]['options']	= false;
$ic++;
$available_items[$ic]['name'] 	= "Recent Added Property";
$available_items[$ic]['desc'] 	= "attach one of your widget bars to your home page";
$available_items[$ic]['icon'] 	= "block9.png";
$available_items[$ic]['id'] 		= "rprecent";
$available_items[$ic]['options']	= false;
$ic++;
...
<fieldset>
<div class="titleh"><h3>Active Home Page Objects</h3></div>
...
<p class="ppnote">Store icons are used with the 'store widget' only and displayed on your sidebar.</p>  
...
<div class="titleh"><h3>Search Results Display</h3></div>
...
<div class="ppt-form-line">     
<span class="ppt-labeltext"># Results Per Page</span>
...
<?php /* ============================ ================================= */ if(strtolower(constant('PREMIUMPRESS_SYSTEM')) == "shopperpress" || strtolower(constant('PREMIUMPRESS_SYSTEM')) == "realtorpress" || strtolower(constant('PREMIUMPRESS_SYSTEM')) == "comparisonpress"){  ?>
...
<?php if(strtolower(PREMIUMPRESS_SYSTEM) != "shopperpress" && strtolower(PREMIUMPRESS_SYSTEM) != "couponpress" ){ ?> 

<div class="ppt-form-line">     
<span class="ppt-labeltext">Ribbon Banner Text</span>
	<input name="adminArray[ppt_featuredtext]" type="text" class="ppt-forminput"  value="<?php echo get_option("ppt_featuredtext"); ?>" /> 
<div class="clearfix"></div>
</div> 
<p class="ppnote" >Here you can set the default ribbon text for featured items. Leave blank to hide the banner ribbon.</p>
...
<div class="ppt-form-line">	
<span class="ppt-labeltext">Did it Work?</span>	 
...
<div class="titleh"><h3>Listing Page Display Options</h3></div>
...
<div class="titleh"><h3>Custom Fields</h3></div>

<p class="ppnote">Custom fields are displayed under the excerpt on the results page.</p>
...
<?php if(strtolower(PREMIUMPRESS_SYSTEM) == "couponpress" || strtolower(PREMIUMPRESS_SYSTEM) == "comparisonpress"){ ?> 

<fieldset>

<div class="titleh"><h3>Customize Store Pages</h3></div>
<div class="ppt-form-line">	
<p>Select a store to create a customize store header/icons. </p>	 
<div id="StoreListID" style="dusplay:visible;">
<select id="storeID" name="storeID" style="width:100%;" onchange="StoreInfo(this.value);">
<option></option>
      <?php echo premiumpress_categorylist($instance['storeID'],false,false,"store"); ?>
</select> 
</div>
<div class="clearfix"></div>
<div id="PPT-storeinfo"></div>
</div>
<p><input class="premiumpress_button" type="submit" value="<?php _e('Save changes','cp')?>" style="color:white;" onclick="document.getElementById('showThisTab').value=2" /></p>
</fieldset>
...
<div class="titleh"><h3>My Account</h3></div>
...
<div class="ppt-form-line">	
<span class="ppt-labeltext">My Favorites</span>	 
...
<div class="titleh"><h3>Slider Options</h3></div>


<div class="ppt-form-line">	
<p>Select a slider to be displayed on your home page.</p>	
...
<fieldset>
<div class="titleh"><h3>Add New Slider Item</h3></div>
 <form method="post" target="_self" >
...
<fieldset>
<div class="titleh"><h3>Manage Slides</h3></div>
...
<input class="premiumpress_button" type="submit" value="Reset Slider (Delete All Slides)" style="color:white;"  onclick="document.getElementById('showThisTab').value=5"/>
</form>                    
<?php } ?>
...
<fieldset>
<div class="titleh"> <h3>Custom Taxonomies</h3></div>
...
echo '<div class="ppt-form-line"><span class="ppt-labeltext">Taxonomy '.$dd.'</span>
		...
		<input name="ppt_custom_tax['.$dd.'][name]" type="text" class="ppt-forminput" value="'.$taxArray[$dd]['name'].'"  style="width:100px;" /></div><div class="clearfix"></div></div>'; ?> 
...
<div class="ppt-form-line">	<a href="javascript:void(0);" onclick="toggleLayer('tax<?php echo $dd+1; ?>');jQuery('#bb<?php echo $dd; ?>').hide();"  style="background:green; color:white; padding:4px;margin-left:10px; float:right; margin-right:20px;">Add New Taxonomy </a><div class="clearfix"></div> 
</div></div></div>
<?php $dd++; } ?>
