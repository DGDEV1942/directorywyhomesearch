...
<div class="itembox">
    ...
    <div id="begin" class="inner">
        ...
        <p class="icon star"><a href="javascript:void(0);" addthis:url="<?php echo get_author_posts_url( $GLOBALS['authorID'], get_the_author_meta( 'user_nicename', $GLOBALS['authorID']) ); ?>" class="addthis_button"><?php echo get_author_posts_url( $GLOBALS['authorID'], get_the_author_meta( 'user_nicename', $GLOBALS['authorID']) ); ?></a></p>
    ...
    <?php } ?>
      	...
      	<a  class="button gray right" href="<?php echo get_option("messages_url"); ?>/?u=<?php echo get_query_var( 'author_name' ); ?>"><?php echo str_replace("%a",get_the_author(),$PPT->_e(array('author','1'))) ?> <img src="<?php echo get_template_directory_uri(); ?>/PPT/img/button/comment.png" /></a>
